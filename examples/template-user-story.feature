...
#
# READY STEP-DEFINITION SKELETONS for TEN stacks — pytest-bdd, behave, cucumber-js,
# cucumber-playwright, Reqnroll/SpecFlow (C#), Behat (PHP), Cucumber-JVM (Java), godog (Go),
# cucumber-cpp (C++), and the Cucumber wire protocol (pure C) — that bind THIS exact feature
# live in  feature-step-defs/  (see feature-step-defs/README.md). Write the Gherkin once;
# pick any stack without rewriting the requirement.
#
