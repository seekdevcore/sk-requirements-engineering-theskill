...
## Status do pt-BR — espelho completo da v1.17.0 (2026-06-11)

> A partir da **v1.10.1** (e mantido até a **v1.17.0**), `translations/pt-BR/` deixou de ser um snapshot congelado da v1.0.x e passou a ser um
