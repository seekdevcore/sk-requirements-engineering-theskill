...
## Status do pt-BR — espelho completo da v1.20.0 (2026-06-12)

> A partir da **v1.10.1** (e mantido até a **v1.20.0**), `translations/pt-BR/` deixou de ser um snapshot congelado da v1.0.x e passou a ser um
...
> - **`references/integrations/openproject.md`** — reescrita: **round-trip via API REST v3 é o método primário** (pull/push, hierarquia por links reais, `lockVersion`, segurança); o `.xlsm` Excel-sync vira **fallback Windows-only** (`winhttpcom.dll`) — v1.20.
