...
> **Modelo do documento de sprint** (`backlog/sprints/sprint-N-<slug>.md`, [template](../../../assets/templates/backlog/sprints/_TEMPLATE.md)): um doc de sprint **referencia** os documentos de Epic/Feature/US (nunca os reescreve — a rastreabilidade fica na origem) e organiza o trabalho em **um bloco por pessoa** (o título do bloco diz *quem*), espelhando o **roadmap do README raiz** do projeto (ver o README do *"SIRA"*). Cada linha carrega **dois eixos de status** cujos valores são **bilíngues — o emoji é o token estável, a palavra segue a língua da pessoa** (EN / pt-BR): **Status** = progresso na sprint + *quem* implícito (**⏳ To do/A fazer · 🔨 Doing/Fazendo · ✅ Done/Feito · ⤳ Skipped/Adiado**) e **Status Final** = estado do PR no GitHub (**✅ Merged/Mergeada · 🔄 In review/Em revisão · 📭 PR open/PR aberta · —**), com a coluna **PR** logo após `Status Final`. Toda US que não couber na sprint vai para a seção final **"Adiados (skipped)"** — com o **motivo** e **qual US** — e seu `Status` vira **⤳ Skipped**. Assim a sprint é uma *visão de execução* fina e link-first, não uma segunda cópia do backlog.
